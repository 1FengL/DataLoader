...
def load_mpii_pose_dataset(path='data', name='mpii_human_pose', is_16_pos_only=False):
...
class MPII(Dataset):
    ...
    def __init__(self, train_or_test, path='data', name='mpii_human_pose', is_16_pos_only=False):
        self.path = os.path.join(path, name)
        img_train_list, ann_train_list, img_test_list, ann_test_list = load_mpii_pose_dataset(path, name, is_16_pos_only)
